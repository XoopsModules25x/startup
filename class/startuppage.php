 ...
 *
 */
class StartupStartuppage extends XoopsObject
{

    /**
 * constructor
 **/
    function StartupStartuppage()
    {
        $this->XoopsObject();
 ...
 *
 */
class StartupStartuppageHandler extends XoopsPersistableObjectHandler
{
    function StartupStartuppageHandler(&$db) {
        $this->XoopsPersistableObjectHandler($db, 'startup_page', 'StartupStartuppage', 'group_id', false);
    }
